...
$query = "SELECT * FROM gym_services gs left join addresses ad ON  gs.address_id=ad.address_id";
        ...
        <div class="listing-container">
            <?php while ($listing = mysqli_fetch_assoc($result)) { ?>
                <div class="property-card">
                    <img src="<?php echo "./assets/uploads/gym-services/" . $listing['main_image']; ?>"
                        class="property-image" alt="Gym Image">
                    <h3 class="address"><?php echo $listing['name']; ?></h3>
                    <span class="tag"><?php echo $listing['city']; ?></span>
                    <button id="popup-button" class="contact-btn">View Details</button>
                    <br>
                </div>
            <?php } ?>
        </div>
