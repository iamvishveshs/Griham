...
$query .= " GROUP BY ms.service_id, adr.address_id";
// Prepare Statement
...
if (!empty($state) && !empty($category_filter)) {
    ...
    mysqli_stmt_bind_param($stmt, "ssssss", $like_location, $like_location, $like_location, $like_location, $like_location, $category_filter);
} else {
...
<head>
    ...
    <title>Dhaba/Tiffin/Cafe Listings</title>
    ...
    <div class="full-container">
        <div>
            ...
            <div class="sidebar" id="sidebar">
                ...
                <form method="GET" action="meal-listings.php">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category">
                            ...
                            <option value="Dhaba" <?php if (isset($_GET['category']) && $_GET['category'] == "Dhaba") echo "selected"; ?>>Dhaba</option>
                            <option value="Tiffin" <?php if (isset($_GET['category']) && $_GET['category'] == "Tiffin") echo "selected"; ?>>Tiffin</option>
                            <option value="Cafe" <?php if (isset($_GET['category']) && $_GET['category'] == "Cafe") echo "selected"; ?>>Cafe</option>
                        </select>
                    </div>
                    <div class="form-group">
                ...
                <?php if ($total_results > 0) {
                            ...
                            <div class="custom-card-content">
                                <div>
                                    <span class="custom-badge"><?php echo htmlspecialchars($row['category']); ?> </span>
                                        <span class=" custom-price save-btn <?php echo $is_saved; ?>" data-id="<?php echo $service_id; ?>" data-type="meal">
                                ...
                                <a href="meal-services-details.php?token=<?php echo urlencode(base64_encode($row['service_id'])); ?>"
                    ...
                    <div class="empty-state">
                        <div class="empty-state__content">
                            <div class="empty-state__message">No Dhaba/Tiffin/Cafe found matching your criteria.</div>
