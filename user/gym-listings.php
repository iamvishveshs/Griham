    ...
    <div class="full-container">
        <div>
            ...
            <div class="sidebar" id="sidebar">
                ...
                <form method="GET" action="gym-listings.php">
                ...
                <?php if ($total_results > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <div class="custom-card">
                            <img src="../assets/uploads/gym-services/<?php echo !empty($row['main_image']) ?  htmlspecialchars($row['main_image']) : "default_property.jpeg"; ?>"
                                class="Property image" alt="Gym image" />
                            <div class="custom-card-content">
                                <div>
                                    <span class="custom-badge"><?php echo htmlspecialchars($row['city']); ?> </span>
                                        <span class=" custom-price save-btn <?php echo $is_saved; ?>" data-id="<?php echo $service_id; ?>" data-type="gym">
                    ...
                    <div class="empty-state">
                        <div class="empty-state__content">
                            <div class="empty-state__message">No Gym found matching your criteria.</div>
