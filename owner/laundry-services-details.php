...
<head>
    ...
    <title><?php echo htmlspecialchars($property['name']); ?> - Laundry Services Details</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="property-details-card">
            <div class="image-section">
                <img src="../assets/uploads/laundry-services/<?php echo htmlspecialchars($property['main_image']); ?>" alt="Main Image">
            </div>
            <div class="info-section">
                <div class="header-text">
                    ...
                    <div class="header-buttons">
                        ...
                        echo '<a href="update-laundry-services.php?token=' . urlencode($token) . '" class="call-button" >Update Details</a>'; ?>
                    </div>
                </div>
                <p><strong>Type:</strong> Laundry & Dry Cleaning</p>
                ...
                <p><strong>Timings:</strong> <?php echo date('g:i A', strtotime(htmlspecialchars($property['opening_hours']))) . " - " . date('g:i A', strtotime(htmlspecialchars($property['closing_hours']))); ?></p>
            </div>
        </div>
    ...
    <?php if($property['pickup'] == 'Yes'): ?>
        <span class="service-item">
            <i class="fas fa-truck"></i> Pickup
        </span>
    <?php endif; ?>
    
    <?php if($property['delivery'] == 'Yes'): ?>
        <span class="service-item">
            <i class="fas fa-shipping-fast"></i> Delivery
        </span>
    <?php endif; ?>
    
    <?php if($property['dry_cleaning'] == 'Yes'): ?>
        <span class="service-item">
            <i class="fas fa-tshirt"></i> Dry Cleaning
        </span>
    <?php endif; ?>
    
    <?php if($property['washing'] == 'Yes'): ?>
        <span class="service-item">
            <i class="fas fa-soap"></i> Washing
        </span>
    <?php endif; ?>
    
    <?php if($property['ironing'] == 'Yes'): ?>
        <span class="service-item">
            <i class="fas fa-tshirt"></i> Ironing
        </span>
    <?php endif; ?>
</div>
            </div>
            ...
            <h3 style="text-align: center; margin-bottom: 15px; color: var(--theme-color);">Other Amenities</h3>
            <ul class="amenities-list">
                ...
                if(!empty($property["amenities"])) {
                    ...
                    echo "<p>No additional amenities listed for this service.</p>";
                }
                ?>
            </ul>
        </div>
            ...
            <div class="slider-container">
                <div class="slider">
                    ...
                    if(!empty($property["images"])) {
                        ...
                        ?>
                            <img src="../assets/uploads/laundry-services/<?php echo htmlspecialchars($image); ?>" alt="LaundryImage">
                        <?php
                        }
                    } else {
                        // If no additional images, show the main image again
                        ?>
                        <img src="../assets/uploads/laundry-services/<?php echo htmlspecialchars($property['main_image']); ?>" alt="LaundryImage">
                        <?php
                    }
                    ?>
