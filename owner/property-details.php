...
require("./check.php");
if (isset($_GET['token'])) {
    $property_id = base64_decode($_GET['token'], true);
    if ($property_id === false || !ctype_digit($property_id)) {
        $_SESSION['error'] = "The property you are trying to access in invalid.";
            ...
            <div class="container">
                ...
                <div class="property-details-card">
                    <div class="image-section">
                        <img src="../assets/uploads/accommodation-images/<?php echo htmlspecialchars($property['main_image']); ?>" alt="Main Image">
                    </div>
                    <div class="info-section">
                        <div class="header-text">
                            ...
                            <div class="header-buttons">
                                ...
                                echo '<a href="update-listing.php?token=' . urlencode($token) . '" class="call-button" >Update Details</a>'; ?>
                            </div>
                        </div>
                ...
                <div class="tab-content" id="amenities">
                    <ul class="amenities-list">
                        <?php
                        foreach (explode(",", $property["amenities"]) as $amenity) {  $amenityArray=explode(":", $amenity)?>
                ...
                <div class="photos">
                    <div class="slider-container">
                        <div class="slider">
                            ...
                            ?>
                                <img src="../assets/uploads/accommodation-images/<?php echo htmlspecialchars($image); ?>" alt="Property Image">
                            <?php
                            }
                            ?>
                        </div>
...
<?php } else {
        $_SESSION['error'] = "The property you are trying to access in not found.";
        header("Location:./browse-listings.php");
        exit();
    }
    mysqli_close($conn);
