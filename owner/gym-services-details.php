    ...
    <div class="container">
        ...
        <div class="property-details-card">
            <div class="image-section">
                <img src="../assets/uploads/gym-services/<?php echo htmlspecialchars($property['main_image']); ?>" alt="Main Image">
            </div>
            <div class="info-section">
                <div class="header-text">
                    ...
                    <div class="header-buttons">
                        ...
                        echo '<a href="update-gym-services.php?token=' . urlencode($token) . '" class="call-button" >Update Details</a>'; ?>
                    </div>
                </div>
                <p><strong>Type:</strong> Gym & Fitness</p>
        ...
        <div class="photos">
            <div class="slider-container">
                <div class="slider">
                    ...
                    ?>
                        <img src="../assets/uploads/gym-services/<?php echo htmlspecialchars($image); ?>" alt="GymImage">
                    <?php
                    }
                    ?>
                </div>
