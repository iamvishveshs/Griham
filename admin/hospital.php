...
LEFT JOIN
    emergency_subcategories esub ON es.subcategory_id = esub.subcategory_id
WHERE
    esc.category_name = 'Hospital'";
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php if (htmlspecialchars($row['is_24_7']) == 1) {
                                        echo "Yes";
                                    } else {
                                        echo "No";
                                    } ?> </td>
